...
function StatusCard({ order, type }) {
    // Ejecuta esta función una sola vez, y memoriza el valor mientras el componente esté montado (random entre 1 y 100)”
    ...
    order?.status_list?.pickup?.[2]?.active || order?.status_list?.dropoff?.[2]?.active;
